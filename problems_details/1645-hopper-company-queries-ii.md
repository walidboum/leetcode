...
**Source:** [https://leetcode.ca/all/1645.html](https://leetcode.ca/all/1645.html)
...
that if the number of available drivers during a month is zero,
                we consider the
...
By the end of November --> six active drivers (10, 8, 5, 7, 4, 1) and two accepted rides by
