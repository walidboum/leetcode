...
**Source:** [https://leetcode.ca/all/460.html](https://leetcode.ca/all/460.html)

**Companies:** Adobe, Amazon, Apple, Bloomberg, Goldman Sachs, Google, LinkedIn, Microsoft, Pinterest, Salesforce, Snapchat, Uber, VMware
...
- Set or insert the value if the key is not already present.
        ...
        or more keys that have the same frequency), the least
