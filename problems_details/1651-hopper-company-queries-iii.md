...
**Source:** [https://leetcode.ca/all/1651.html](https://leetcode.ca/all/1651.html)
...
of every 3-month window starting from
...
is calculated by summing up the total

ride_distance

values from the three months and dividing it by
...
is the starting month's number (January is
