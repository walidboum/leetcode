...
**Source:** [https://leetcode.ca/all/1357.html](https://leetcode.ca/all/1357.html)
...
and the price per unit of this product is

prices[i]

.

The system will count the number of customers and when the

n-th

customer
            arrive he/she will have a

discount

on the bill. (i.e if the cost is
...
product the customer ordered and
