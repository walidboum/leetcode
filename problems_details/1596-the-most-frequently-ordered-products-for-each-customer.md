...
**Source:** [https://leetcode.ca/all/1596.html](https://leetcode.ca/all/1596.html)
...
No customer will order the same product
...
The result table should have the
...
who ordered at least one
                order. Return the result table in
