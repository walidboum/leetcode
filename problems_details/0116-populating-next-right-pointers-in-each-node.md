...
**Source:** [https://leetcode.ca/all/116.html](https://leetcode.ca/all/116.html)

**Companies:** Amazon, Apple, Bloomberg, Facebook, Google, Microsoft, Nutanix, Oracle, VMware
...
Populate each next pointer to point to its next right node. If there is no next right node,
        the next pointer should be set to
