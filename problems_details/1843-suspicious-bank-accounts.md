...
**Source:** [https://leetcode.ca/all/1843.html](https://leetcode.ca/all/1843.html)
...
Write an SQL query to report the IDs of all
...
of an account in some month is the sum of all its deposits in that month (i.e., transactions of the type
